        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-10 grid grid-cols-1 md:grid-cols-3 gap-8 text-sm">
          ...
          <div>
            ...
            <p className="leading-relaxed text-white/70">
              SAP IS-U, OSIsoft PI, Itron AMI, Salesforce, GIS, NOAA → Fivetran → Iceberg on S3 → dbt → Great Expectations → Snowflake / Athena / Trino → dbt-wizard run-time agents → NewCo Activations → Maximo.
            </p>
