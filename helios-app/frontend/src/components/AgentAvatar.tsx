...
// Ported from Healthcare-EPIC-Snowflake-Demo for Helios Energy.
...
export default function AgentAvatar({ agent, systemColor = '#06b6d4', active = false, size = 40, from }: Props) {
